...
import { Shield, Settings, Users, CreditCard, FileText, Eye, Wallet } from 'lucide-react';
...
const featureIcons: Record<string, React.ReactNode> = {
  ...
  fund_manage: <Wallet className="w-5 h-5" />,
  fund_view: <Wallet className="w-5 h-5" />,
};
...
const featureCategories: Record<string, string[]> = {
  ...
  'Fund Management': ['fund_manage', 'fund_view'],
  'Reports & Visibility': [
    'view_dashboard',
    'view_agent_report',
